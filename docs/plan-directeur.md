...
- **9 — Suite** : notifications WhatsApp/push + préférences ; storefront PWA/i18n/thème éditable ; dashboard analytique ; `apps/admin` ; SuperTokens/OAuth/OTP ; tests d'intégration Testcontainers en CI.
