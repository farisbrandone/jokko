...
- **8 — Suite** : notifications sur nouveau message (Outbox → e-mail/WhatsApp/push) ; storefront PWA/i18n/thème éditable ; dashboard analytique ; `apps/admin` ; SuperTokens/OAuth/OTP ; tests d'intégration Testcontainers en CI.
